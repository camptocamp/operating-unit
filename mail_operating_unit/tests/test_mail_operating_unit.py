from odoo.addons.mail_operating_unit.tests.common import MailOperatingUnitCommon
...
class TestMailOperatingUnit(MailOperatingUnitCommon):
    def test_mail_template_with_operating_unit(self):
        ...
        self.assertEqual(mail.email_from, self.ou_alias_domain.default_from_email)
    ...
    def test_user_single_operating_unit(self):
        ...
        message = self.user3.partner_id.with_user(self.user3).message_post(
            body="Test", author_id=self.user3.partner_id.id
        )

...
It also allows you to define an Outgoing Mail Server on an Operating Unit and, when enabled in General Settings, automatically route emails through that server when no mail server is explicitly defined on the email template.
